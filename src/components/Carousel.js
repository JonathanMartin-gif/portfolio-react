 ...
 constructor(props) {
  ...
  this.state = {
   items: [{
    ...
    imgSrc: github1,
    link: 'https://jonathanmartin-gif.github.io/project-local-library-master/public/',
    selected: false
   },
  {
   id:1,
   title: 'Decoder Ring Project',
   subTitle: 'A Decoder Ring that Decodes and Encodes using Javascript Algorithms.',
   imgSrc: github1,
  ...
  {
   id: 2,
   title: 'Pomodoro Timer (Coming Soon)',
   subTitle: 'A time project in React.js.',
   imgSrc: github2,
   link: 'https://jonathanmartin-gif.github.io/project-pomodoro-timer/',
   selected: false
  }]
  }
 }
